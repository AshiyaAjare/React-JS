...
import { useQueryContainer } from "../container/ViewQueryLogic";
import { queryStyles, cx } from "../../Shared/components/Styles";
import { CheckCircleIcon } from 'lucide-react';

// Import or define the types (based on the previous artifact)
      ...
      <div className={queryStyles.card}>
        ...
        <div className={queryStyles.responsesSection}>
          ...
          <div className={queryStyles.responsesList}> 
            {query.responses?.length > 0 ? (
              query.responses.map((response: Response) => {
